...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApiWalletMigrationInfoMigrationCost :  IEquatable<ApiWalletMigrationInfoMigrationCost>, IValidatableObject
    {
        /// <summary>
        /// Defines Unit
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiWalletMigrationInfoMigrationCost {\n");
        ...
        {
            return this.Equals(input as ApiWalletMigrationInfoMigrationCost);
        }

        /// <summary>
        /// Returns true if ApiWalletMigrationInfoMigrationCost instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiWalletMigrationInfoMigrationCost to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiWalletMigrationInfoMigrationCost input)
        {
            if (input == null)
                return false;
