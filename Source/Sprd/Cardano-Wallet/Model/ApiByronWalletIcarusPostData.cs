...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApiByronWalletIcarusPostData :  IEquatable<ApiByronWalletIcarusPostData>, IValidatableObject
    {
        /// <summary>
        /// Defines Style
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiByronWalletIcarusPostData" /> class.
        /// </summary>
        ...
        public ApiByronWalletIcarusPostData(StyleEnum? style = default(StyleEnum?), string name = default(string), string passphrase = default(string), List<string> mnemonicSentence = default(List<string>))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ApiByronWalletIcarusPostData and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (passphrase == null)
            {
                throw new InvalidDataException("passphrase is a required property for ApiByronWalletIcarusPostData and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("mnemonicSentence is a required property for ApiByronWalletIcarusPostData and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiByronWalletIcarusPostData {\n");
        ...
        {
            return this.Equals(input as ApiByronWalletIcarusPostData);
        }

        /// <summary>
        /// Returns true if ApiByronWalletIcarusPostData instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiByronWalletIcarusPostData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiByronWalletIcarusPostData input)
        {
            if (input == null)
                return false;
