...
{
    /// <summary>
    /// ApiCoinSelectionWithdrawals
    /// </summary>
    [DataContract]
        public partial class ApiCoinSelectionWithdrawals :  IEquatable<ApiCoinSelectionWithdrawals>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiCoinSelectionWithdrawals {\n");
        ...
        {
            return this.Equals(input as ApiCoinSelectionWithdrawals);
        }

        /// <summary>
        /// Returns true if ApiCoinSelectionWithdrawals instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiCoinSelectionWithdrawals to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiCoinSelectionWithdrawals input)
        {
            if (input == null)
                return false;
