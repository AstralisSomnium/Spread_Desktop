...
namespace IO.Swagger.Model
{
        ...
        public partial class Body14 :  IEquatable<Body14>, IValidatableObject
    {
        ...
        public Body14(string oldPassphrase = default(string), string newPassphrase = default(string))
        {
            // to ensure "newPassphrase" is required (not null)
            if (newPassphrase == null)
            {
                throw new InvalidDataException("newPassphrase is a required property for Body14 and cannot be null");
            }
            else
            {
