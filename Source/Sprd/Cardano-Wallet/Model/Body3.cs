...
namespace IO.Swagger.Model
{
        ...
        public partial class Body3 :  IEquatable<Body3>, IValidatableObject
    {
        ...
        public Body3(string oldPassphrase = default(string), string newPassphrase = default(string))
        {
            // to ensure "oldPassphrase" is required (not null)
            if (oldPassphrase == null)
            {
                throw new InvalidDataException("oldPassphrase is a required property for Body3 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("newPassphrase is a required property for Body3 and cannot be null");
            }
            else
            {
