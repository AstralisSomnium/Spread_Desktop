...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse2009 :  IEquatable<InlineResponse2009>, IValidatableObject
    {
        ...
        public InlineResponse2009(ApiWalletMigrationInfoMigrationCost migrationCost = default(ApiWalletMigrationInfoMigrationCost), ApiWalletMigrationInfoLeftovers leftovers = default(ApiWalletMigrationInfoLeftovers))
        {
            // to ensure "migrationCost" is required (not null)
            if (migrationCost == null)
            {
                throw new InvalidDataException("migrationCost is a required property for InlineResponse2009 and cannot be null");
            }
            else
            {
            ...
            if (leftovers == null)
            {
                throw new InvalidDataException("leftovers is a required property for InlineResponse2009 and cannot be null");
            }
            else
            {
