...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20011 :  IEquatable<InlineResponse20011>, IValidatableObject
    {
        ...
        public InlineResponse20011(ApiNetworkInformationSyncProgress syncProgress = default(ApiNetworkInformationSyncProgress), ApiNetworkInformationNodeTip nodeTip = default(ApiNetworkInformationNodeTip), ApiNetworkInformationNetworkTip networkTip = default(ApiNetworkInformationNetworkTip), WalletsDelegationChangesAt nextEpoch = default(WalletsDelegationChangesAt), NodeEraEnum nodeEra = default(NodeEraEnum))
        {
            // to ensure "syncProgress" is required (not null)
            if (syncProgress == null)
            {
                throw new InvalidDataException("syncProgress is a required property for InlineResponse20011 and cannot be null");
            }
            else
            {
            ...
            if (nodeTip == null)
            {
                throw new InvalidDataException("nodeTip is a required property for InlineResponse20011 and cannot be null");
            }
            else
            {
            ...
            if (nodeEra == null)
            {
                throw new InvalidDataException("nodeEra is a required property for InlineResponse20011 and cannot be null");
            }
            else
            {
