...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApiNetworkInformationNodeTip :  IEquatable<ApiNetworkInformationNodeTip>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiNetworkInformationNodeTip" /> class.
        /// </summary>
        ...
        public ApiNetworkInformationNodeTip(int? absoluteSlotNumber = default(int?), int? slotNumber = default(int?), int? epochNumber = default(int?), string time = default(string), WalletsTipHeight height = default(WalletsTipHeight))
        {
            // to ensure "absoluteSlotNumber" is required (not null)
            if (absoluteSlotNumber == null)
            {
                throw new InvalidDataException("absoluteSlotNumber is a required property for ApiNetworkInformationNodeTip and cannot be null");
            }
            else
            {
            ...
            if (slotNumber == null)
            {
                throw new InvalidDataException("slotNumber is a required property for ApiNetworkInformationNodeTip and cannot be null");
            }
            else
            {
            ...
            if (epochNumber == null)
            {
                throw new InvalidDataException("epochNumber is a required property for ApiNetworkInformationNodeTip and cannot be null");
            }
            else
            {
            ...
            if (time == null)
            {
                throw new InvalidDataException("time is a required property for ApiNetworkInformationNodeTip and cannot be null");
            }
            else
            {
                this.Time = time;
            ...
            if (height == null)
            {
                throw new InvalidDataException("height is a required property for ApiNetworkInformationNodeTip and cannot be null");
            }
            else
            {
                this.Height = height;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiNetworkInformationNodeTip {\n");
        ...
        {
            return this.Equals(input as ApiNetworkInformationNodeTip);
        }

        /// <summary>
        /// Returns true if ApiNetworkInformationNodeTip instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiNetworkInformationNodeTip to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiNetworkInformationNodeTip input)
        {
            if (input == null)
                return false;
