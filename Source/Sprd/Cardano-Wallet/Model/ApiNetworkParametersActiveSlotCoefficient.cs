...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApiNetworkParametersActiveSlotCoefficient :  IEquatable<ApiNetworkParametersActiveSlotCoefficient>, IValidatableObject
    {
        /// <summary>
        /// Defines Unit
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiNetworkParametersActiveSlotCoefficient {\n");
        ...
        {
            return this.Equals(input as ApiNetworkParametersActiveSlotCoefficient);
        }

        /// <summary>
        /// Returns true if ApiNetworkParametersActiveSlotCoefficient instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiNetworkParametersActiveSlotCoefficient to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiNetworkParametersActiveSlotCoefficient input)
        {
            if (input == null)
                return false;
