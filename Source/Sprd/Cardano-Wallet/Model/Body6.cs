...
namespace IO.Swagger.Model
{
        ...
        public partial class Body6 :  IEquatable<Body6>, IValidatableObject
    {
        ...
        public Body6(string passphrase = default(string), bool? extended = default(bool?))
        {
            // to ensure "passphrase" is required (not null)
            if (passphrase == null)
            {
                throw new InvalidDataException("passphrase is a required property for Body6 and cannot be null");
            }
            else
            {
            ...
            if (extended == null)
            {
                throw new InvalidDataException("extended is a required property for Body6 and cannot be null");
            }
            else
            {
