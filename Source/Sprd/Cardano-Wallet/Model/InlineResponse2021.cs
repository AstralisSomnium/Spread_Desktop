...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse2021 :  IEquatable<InlineResponse2021>, IValidatableObject
    {
        ...
        public InlineResponse2021(string id = default(string), WalletswalletIdtransactionsAmount amount = default(WalletswalletIdtransactionsAmount), WalletswalletIdpaymentfeesAmount fee = default(WalletswalletIdpaymentfeesAmount), WalletswalletIdpaymentfeesAmount deposit = default(WalletswalletIdpaymentfeesAmount), WalletswalletIdtransactionsInsertedAt insertedAt = default(WalletswalletIdtransactionsInsertedAt), WalletswalletIdtransactionsExpiresAt expiresAt = default(WalletswalletIdtransactionsExpiresAt), WalletswalletIdtransactionsPendingSince pendingSince = default(WalletswalletIdtransactionsPendingSince), WalletswalletIdtransactionsDepth depth = default(WalletswalletIdtransactionsDepth), DirectionEnum direction = default(DirectionEnum), List<WalletswalletIdtransactionsInputs> inputs = default(List<WalletswalletIdtransactionsInputs>), List<WalletswalletIdpaymentfeesPayments> outputs = default(List<WalletswalletIdpaymentfeesPayments>), List<WalletswalletIdtransactionsWithdrawals> withdrawals = default(List<WalletswalletIdtransactionsWithdrawals>), List<WalletswalletIdtransactionsMint> mint = default(List<WalletswalletIdtransactionsMint>), StatusEnum status = default(StatusEnum), Dictionary<string, TransactionMetadataValue> metadata = default(Dictionary<string, TransactionMetadataValue>))
        {
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for InlineResponse2021 and cannot be null");
            }
            else
            {
                this.Amount = amount;
            ...
            if (fee == null)
            {
                throw new InvalidDataException("fee is a required property for InlineResponse2021 and cannot be null");
            }
            else
            {
                this.Fee = fee;
            ...
            if (deposit == null)
            {
                throw new InvalidDataException("deposit is a required property for InlineResponse2021 and cannot be null");
            }
            else
            {
            ...
            if (direction == null)
            {
                throw new InvalidDataException("direction is a required property for InlineResponse2021 and cannot be null");
            }
            else
            {
            ...
            if (inputs == null)
            {
                throw new InvalidDataException("inputs is a required property for InlineResponse2021 and cannot be null");
            }
            else
            {
                this.Inputs = inputs;
            ...
            if (outputs == null)
            {
                throw new InvalidDataException("outputs is a required property for InlineResponse2021 and cannot be null");
            }
            else
            {
            ...
            if (withdrawals == null)
            {
                throw new InvalidDataException("withdrawals is a required property for InlineResponse2021 and cannot be null");
            }
            else
            {
            ...
            if (mint == null)
            {
                throw new InvalidDataException("mint is a required property for InlineResponse2021 and cannot be null");
            }
            else
            {
                this.Mint = mint;
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for InlineResponse2021 and cannot be null");
            }
            else
            {
                this.Status = status;
