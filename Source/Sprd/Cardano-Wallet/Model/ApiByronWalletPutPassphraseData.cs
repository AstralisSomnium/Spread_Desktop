...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApiByronWalletPutPassphraseData :  IEquatable<ApiByronWalletPutPassphraseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiByronWalletPutPassphraseData" /> class.
        /// </summary>
        /// <param name="oldPassphrase">The current passphrase if present..</param>
        ...
        public ApiByronWalletPutPassphraseData(string oldPassphrase = default(string), string newPassphrase = default(string))
        {
            // to ensure "newPassphrase" is required (not null)
            if (newPassphrase == null)
            {
                throw new InvalidDataException("newPassphrase is a required property for ApiByronWalletPutPassphraseData and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>The current passphrase if present.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiByronWalletPutPassphraseData {\n");
        ...
        {
            return this.Equals(input as ApiByronWalletPutPassphraseData);
        }

        /// <summary>
        /// Returns true if ApiByronWalletPutPassphraseData instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiByronWalletPutPassphraseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiByronWalletPutPassphraseData input)
        {
            if (input == null)
                return false;
