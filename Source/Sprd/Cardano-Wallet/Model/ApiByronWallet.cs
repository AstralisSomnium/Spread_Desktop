...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApiByronWallet :  IEquatable<ApiByronWallet>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiByronWallet {\n");
        ...
        {
            return this.Equals(input as ApiByronWallet);
        }

        /// <summary>
        /// Returns true if ApiByronWallet instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiByronWallet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiByronWallet input)
        {
            if (input == null)
                return false;
