...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse20010 :  IEquatable<InlineResponse20010>, IValidatableObject
    {
        ...
        public InlineResponse20010(string id = default(string), ByronwalletsBalance balance = default(ByronwalletsBalance), WalletsAssets assets = default(WalletsAssets), DiscoveryEnum discovery = default(DiscoveryEnum), string name = default(string), WalletsPassphrase passphrase = default(WalletsPassphrase), WalletsState state = default(WalletsState), WalletsTip tip = default(WalletsTip))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for InlineResponse20010 and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (balance == null)
            {
                throw new InvalidDataException("balance is a required property for InlineResponse20010 and cannot be null");
            }
            else
            {
            ...
            if (assets == null)
            {
                throw new InvalidDataException("assets is a required property for InlineResponse20010 and cannot be null");
            }
            else
            {
                this.Assets = assets;
            ...
            if (discovery == null)
            {
                throw new InvalidDataException("discovery is a required property for InlineResponse20010 and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for InlineResponse20010 and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (state == null)
            {
                throw new InvalidDataException("state is a required property for InlineResponse20010 and cannot be null");
            }
            else
            {
                this.State = state;
            ...
            if (tip == null)
            {
                throw new InvalidDataException("tip is a required property for InlineResponse20010 and cannot be null");
            }
            else
            {
                this.Tip = tip;
