...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApiNetworkInformationNetworkTip :  IEquatable<ApiNetworkInformationNetworkTip>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiNetworkInformationNetworkTip" /> class.
        /// </summary>
        ...
        public ApiNetworkInformationNetworkTip(int? absoluteSlotNumber = default(int?), int? epochNumber = default(int?), int? slotNumber = default(int?), string time = default(string))
        {
            // to ensure "absoluteSlotNumber" is required (not null)
            if (absoluteSlotNumber == null)
            {
                throw new InvalidDataException("absoluteSlotNumber is a required property for ApiNetworkInformationNetworkTip and cannot be null");
            }
            else
            {
            ...
            if (epochNumber == null)
            {
                throw new InvalidDataException("epochNumber is a required property for ApiNetworkInformationNetworkTip and cannot be null");
            }
            else
            {
            ...
            if (slotNumber == null)
            {
                throw new InvalidDataException("slotNumber is a required property for ApiNetworkInformationNetworkTip and cannot be null");
            }
            else
            {
            ...
            if (time == null)
            {
                throw new InvalidDataException("time is a required property for ApiNetworkInformationNetworkTip and cannot be null");
            }
            else
            {
                this.Time = time;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiNetworkInformationNetworkTip {\n");
        ...
        {
            return this.Equals(input as ApiNetworkInformationNetworkTip);
        }

        /// <summary>
        /// Returns true if ApiNetworkInformationNetworkTip instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiNetworkInformationNetworkTip to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiNetworkInformationNetworkTip input)
        {
            if (input == null)
                return false;
