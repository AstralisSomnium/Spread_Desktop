...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class NullableEpochInfo :  IEquatable<NullableEpochInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NullableEpochInfo" /> class.
        /// </summary>
        ...
        public NullableEpochInfo(int? epochNumber = default(int?), string epochStartTime = default(string))
        {
            // to ensure "epochNumber" is required (not null)
            if (epochNumber == null)
            {
                throw new InvalidDataException("epochNumber is a required property for NullableEpochInfo and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("epochStartTime is a required property for NullableEpochInfo and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NullableEpochInfo {\n");
        ...
        {
            return this.Equals(input as NullableEpochInfo);
        }

        /// <summary>
        /// Returns true if NullableEpochInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of NullableEpochInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NullableEpochInfo input)
        {
            if (input == null)
                return false;
