...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApiHealthCheck :  IEquatable<ApiHealthCheck>, IValidatableObject
    {
        /// <summary>
        /// Defines Health
        /// </summary>
        ...
        {
            return this.Equals(input as ApiHealthCheck);
        }

        /// <summary>
        /// Returns true if ApiHealthCheck instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiHealthCheck to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiHealthCheck input)
        {
            if (input == null)
                return false;
