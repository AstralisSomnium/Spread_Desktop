...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApiNetworkTip :  IEquatable<ApiNetworkTip>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiNetworkTip" /> class.
        /// </summary>
        ...
        public ApiNetworkTip(int? absoluteSlotNumber = default(int?), int? epochNumber = default(int?), int? slotNumber = default(int?), string time = default(string))
        {
            // to ensure "absoluteSlotNumber" is required (not null)
            if (absoluteSlotNumber == null)
            {
                throw new InvalidDataException("absoluteSlotNumber is a required property for ApiNetworkTip and cannot be null");
            }
            else
            {
            ...
            if (epochNumber == null)
            {
                throw new InvalidDataException("epochNumber is a required property for ApiNetworkTip and cannot be null");
            }
            else
            {
            ...
            if (slotNumber == null)
            {
                throw new InvalidDataException("slotNumber is a required property for ApiNetworkTip and cannot be null");
            }
            else
            {
            ...
            if (time == null)
            {
                throw new InvalidDataException("time is a required property for ApiNetworkTip and cannot be null");
            }
            else
            {
                this.Time = time;
        ...
        {
            return this.Equals(input as ApiNetworkTip);
        }

        /// <summary>
        /// Returns true if ApiNetworkTip instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiNetworkTip to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiNetworkTip input)
        {
            if (input == null)
                return false;
