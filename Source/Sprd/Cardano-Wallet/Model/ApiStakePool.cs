...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApiStakePool :  IEquatable<ApiStakePool>, IValidatableObject
    {
        /// <summary>
        /// Defines Flags
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiStakePool" /> class.
        /// </summary>
        ...
        public ApiStakePool(string id = default(string), StakepoolsMetrics metrics = default(StakepoolsMetrics), StakepoolsCost cost = default(StakepoolsCost), StakepoolsMargin margin = default(StakepoolsMargin), StakepoolsPledge pledge = default(StakepoolsPledge), StakepoolsMetadata metadata = default(StakepoolsMetadata), StakepoolsRetirement retirement = default(StakepoolsRetirement), List<FlagsEnum> flags = default(List<FlagsEnum>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ApiStakePool and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (metrics == null)
            {
                throw new InvalidDataException("metrics is a required property for ApiStakePool and cannot be null");
            }
            else
            {
            ...
            if (cost == null)
            {
                throw new InvalidDataException("cost is a required property for ApiStakePool and cannot be null");
            }
            else
            {
                this.Cost = cost;
            ...
            if (margin == null)
            {
                throw new InvalidDataException("margin is a required property for ApiStakePool and cannot be null");
            }
            else
            {
                this.Margin = margin;
            ...
            if (pledge == null)
            {
                throw new InvalidDataException("pledge is a required property for ApiStakePool and cannot be null");
            }
            else
            {
                this.Pledge = pledge;
            ...
            if (flags == null)
            {
                throw new InvalidDataException("flags is a required property for ApiStakePool and cannot be null");
            }
            else
            {
                this.Flags = flags;
        ...
        {
            return this.Equals(input as ApiStakePool);
        }

        /// <summary>
        /// Returns true if ApiStakePool instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiStakePool to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiStakePool input)
        {
            if (input == null)
                return false;
