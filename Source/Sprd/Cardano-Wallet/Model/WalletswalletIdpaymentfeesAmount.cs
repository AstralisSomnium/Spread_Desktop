...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class WalletswalletIdpaymentfeesAmount :  IEquatable<WalletswalletIdpaymentfeesAmount>, IValidatableObject
    {
        /// <summary>
        /// Defines Unit
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WalletswalletIdpaymentfeesAmount {\n");
        ...
        {
            return this.Equals(input as WalletswalletIdpaymentfeesAmount);
        }

        /// <summary>
        /// Returns true if WalletswalletIdpaymentfeesAmount instances are equal
        /// </summary>
        /// <param name="input">Instance of WalletswalletIdpaymentfeesAmount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WalletswalletIdpaymentfeesAmount input)
        {
            if (input == null)
                return false;
