...
namespace IO.Swagger.Model
{
        ...
        public partial class StakepoolsMetricsProducedBlocks :  IEquatable<StakepoolsMetricsProducedBlocks>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StakepoolsMetricsProducedBlocks {\n");
        ...
        {
            return this.Equals(input as StakepoolsMetricsProducedBlocks);
        }

        /// <summary>
        /// Returns true if StakepoolsMetricsProducedBlocks instances are equal
        /// </summary>
        /// <param name="input">Instance of StakepoolsMetricsProducedBlocks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StakepoolsMetricsProducedBlocks input)
        {
            if (input == null)
                return false;
