...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class WalletsAssetsAvailable :  IEquatable<WalletsAssetsAvailable>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WalletsAssetsAvailable" /> class.
        /// </summary>
        ...
        /// <param name="quantity">Number of assets for the given &#x60;policy_id&#x60; and &#x60;asset_name&#x60;.  (required).</param>
        public WalletsAssetsAvailable(string policyId = default(string), string assetName = default(string), int? quantity = default(int?))
        {
            // to ensure "policyId" is required (not null)
            if (policyId == null)
            {
                throw new InvalidDataException("policyId is a required property for WalletsAssetsAvailable and cannot be null");
            }
            else
            {
            ...
            if (assetName == null)
            {
                throw new InvalidDataException("assetName is a required property for WalletsAssetsAvailable and cannot be null");
            }
            else
            {
            ...
            if (quantity == null)
            {
                throw new InvalidDataException("quantity is a required property for WalletsAssetsAvailable and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Number of assets for the given &#x60;policy_id&#x60; and &#x60;asset_name&#x60;. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WalletsAssetsAvailable {\n");
        ...
        {
            return this.Equals(input as WalletsAssetsAvailable);
        }

        /// <summary>
        /// Returns true if WalletsAssetsAvailable instances are equal
        /// </summary>
        /// <param name="input">Instance of WalletsAssetsAvailable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WalletsAssetsAvailable input)
        {
            if (input == null)
                return false;
