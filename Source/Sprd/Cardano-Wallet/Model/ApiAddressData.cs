...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApiAddressData :  IEquatable<ApiAddressData>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiAddressData" /> class.
        /// </summary>
        ...
        public ApiAddressData(OneOfApiAddressDataPayment payment = default(OneOfApiAddressDataPayment), OneOfApiAddressDataStake stake = default(OneOfApiAddressDataStake), ValidationEnum? validation = default(ValidationEnum?))
        {
        ...
        public OneOfApiAddressDataPayment Payment { get; set; }

        /// <summary>
        /// Gets or Sets Stake
        /// </summary>
        [DataMember(Name="stake", EmitDefaultValue=false)]
        public OneOfApiAddressDataStake Stake { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiAddressData {\n");
        ...
        {
            return this.Equals(input as ApiAddressData);
        }

        /// <summary>
        /// Returns true if ApiAddressData instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiAddressData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiAddressData input)
        {
            if (input == null)
                return false;
