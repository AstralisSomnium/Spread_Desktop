...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class WalletsDelegationNext :  IEquatable<WalletsDelegationNext>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WalletsDelegationNext {\n");
        ...
        {
            return this.Equals(input as WalletsDelegationNext);
        }

        /// <summary>
        /// Returns true if WalletsDelegationNext instances are equal
        /// </summary>
        /// <param name="input">Instance of WalletsDelegationNext to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WalletsDelegationNext input)
        {
            if (input == null)
                return false;
