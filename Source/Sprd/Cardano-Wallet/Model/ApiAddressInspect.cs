...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApiAddressInspect :  IEquatable<ApiAddressInspect>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiAddressInspect" /> class.
        /// </summary>
        ...
        public ApiAddressInspect(AddressStyleEnum addressStyle = default(AddressStyleEnum), StakeReferenceEnum stakeReference = default(StakeReferenceEnum), int? networkTag = default(int?), string spendingKeyHash = default(string), string stakeKeyHash = default(string), string scriptHash = default(string), ApiAddressInspectPointer pointer = default(ApiAddressInspectPointer), string addressRoot = default(string), string derivationPath = default(string))
        {
            // to ensure "addressStyle" is required (not null)
            if (addressStyle == null)
            {
                throw new InvalidDataException("addressStyle is a required property for ApiAddressInspect and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("stakeReference is a required property for ApiAddressInspect and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiAddressInspect {\n");
        ...
        {
            return this.Equals(input as ApiAddressInspect);
        }

        /// <summary>
        /// Returns true if ApiAddressInspect instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiAddressInspect to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiAddressInspect input)
        {
            if (input == null)
                return false;
