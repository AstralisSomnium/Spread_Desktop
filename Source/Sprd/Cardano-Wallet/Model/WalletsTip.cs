...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class WalletsTip :  IEquatable<WalletsTip>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WalletsTip" /> class.
        /// </summary>
        ...
        public WalletsTip(int? absoluteSlotNumber = default(int?), int? slotNumber = default(int?), int? epochNumber = default(int?), string time = default(string), WalletsTipHeight height = default(WalletsTipHeight))
        {
            // to ensure "absoluteSlotNumber" is required (not null)
            if (absoluteSlotNumber == null)
            {
                throw new InvalidDataException("absoluteSlotNumber is a required property for WalletsTip and cannot be null");
            }
            else
            {
            ...
            if (slotNumber == null)
            {
                throw new InvalidDataException("slotNumber is a required property for WalletsTip and cannot be null");
            }
            else
            {
            ...
            if (epochNumber == null)
            {
                throw new InvalidDataException("epochNumber is a required property for WalletsTip and cannot be null");
            }
            else
            {
            ...
            if (time == null)
            {
                throw new InvalidDataException("time is a required property for WalletsTip and cannot be null");
            }
            else
            {
                this.Time = time;
            ...
            if (height == null)
            {
                throw new InvalidDataException("height is a required property for WalletsTip and cannot be null");
            }
            else
            {
                this.Height = height;
        ...
        {
            return this.Equals(input as WalletsTip);
        }

        /// <summary>
        /// Returns true if WalletsTip instances are equal
        /// </summary>
        /// <param name="input">Instance of WalletsTip to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WalletsTip input)
        {
            if (input == null)
                return false;
