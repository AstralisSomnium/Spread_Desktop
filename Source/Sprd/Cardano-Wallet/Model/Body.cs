...
namespace IO.Swagger.Model
{
        ...
        public partial class Body :  IEquatable<Body>, IValidatableObject
    {
        ...
        public Body(string passphrase = default(string), Dictionary<string, TransactionMetadataValue> metadata = default(Dictionary<string, TransactionMetadataValue>))
        {
            // to ensure "passphrase" is required (not null)
            if (passphrase == null)
            {
                throw new InvalidDataException("passphrase is a required property for Body and cannot be null");
            }
            else
            {
            ...
            if (metadata == null)
            {
                throw new InvalidDataException("metadata is a required property for Body and cannot be null");
            }
            else
            {
