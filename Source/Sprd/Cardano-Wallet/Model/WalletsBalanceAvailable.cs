...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class WalletsBalanceAvailable :  IEquatable<WalletsBalanceAvailable>, IValidatableObject
    {
        /// <summary>
        /// Defines Unit
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WalletsBalanceAvailable {\n");
        ...
        {
            return this.Equals(input as WalletsBalanceAvailable);
        }

        /// <summary>
        /// Returns true if WalletsBalanceAvailable instances are equal
        /// </summary>
        /// <param name="input">Instance of WalletsBalanceAvailable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WalletsBalanceAvailable input)
        {
            if (input == null)
                return false;
