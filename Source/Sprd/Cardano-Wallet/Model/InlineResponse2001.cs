...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse2001 :  IEquatable<InlineResponse2001>, IValidatableObject
    {
        ...
        public InlineResponse2001(string policyId = default(string), string assetName = default(string), string fingerprint = default(string), NativeAssetsMetadata metadata = default(NativeAssetsMetadata))
        {
            // to ensure "policyId" is required (not null)
            if (policyId == null)
            {
                throw new InvalidDataException("policyId is a required property for InlineResponse2001 and cannot be null");
            }
            else
            {
            ...
            if (assetName == null)
            {
                throw new InvalidDataException("assetName is a required property for InlineResponse2001 and cannot be null");
            }
            else
            {
            ...
            if (fingerprint == null)
            {
                throw new InvalidDataException("fingerprint is a required property for InlineResponse2001 and cannot be null");
            }
            else
            {
