...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApiByronWalletLedgerPostData :  IEquatable<ApiByronWalletLedgerPostData>, IValidatableObject
    {
        /// <summary>
        /// Defines Style
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiByronWalletLedgerPostData" /> class.
        /// </summary>
        ...
        public ApiByronWalletLedgerPostData(StyleEnum? style = default(StyleEnum?), string name = default(string), string passphrase = default(string), List<string> mnemonicSentence = default(List<string>))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ApiByronWalletLedgerPostData and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (passphrase == null)
            {
                throw new InvalidDataException("passphrase is a required property for ApiByronWalletLedgerPostData and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("mnemonicSentence is a required property for ApiByronWalletLedgerPostData and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiByronWalletLedgerPostData {\n");
        ...
        {
            return this.Equals(input as ApiByronWalletLedgerPostData);
        }

        /// <summary>
        /// Returns true if ApiByronWalletLedgerPostData instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiByronWalletLedgerPostData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiByronWalletLedgerPostData input)
        {
            if (input == null)
                return false;
