...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApiCoinSelection :  IEquatable<ApiCoinSelection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiCoinSelection" /> class.
        /// </summary>
        ...
        public ApiCoinSelection(List<ApiCoinSelectionInputs> inputs = default(List<ApiCoinSelectionInputs>), List<WalletswalletIdpaymentfeesPayments> outputs = default(List<WalletswalletIdpaymentfeesPayments>), List<ApiCoinSelectionChange> change = default(List<ApiCoinSelectionChange>), List<ApiCoinSelectionWithdrawals> withdrawals = default(List<ApiCoinSelectionWithdrawals>), List<ApiCoinSelectionCertificates> certificates = default(List<ApiCoinSelectionCertificates>), List<WalletswalletIdpaymentfeesAmount> deposits = default(List<WalletswalletIdpaymentfeesAmount>), string metadata = default(string))
        {
            ...
            if (outputs == null)
            {
                throw new InvalidDataException("outputs is a required property for ApiCoinSelection and cannot be null");
            }
            else
            {
            ...
            if (change == null)
            {
                throw new InvalidDataException("change is a required property for ApiCoinSelection and cannot be null");
            }
            else
            {
                this.Change = change;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiCoinSelection {\n");
        ...
        {
            return this.Equals(input as ApiCoinSelection);
        }

        /// <summary>
        /// Returns true if ApiCoinSelection instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiCoinSelection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiCoinSelection input)
        {
            if (input == null)
                return false;
