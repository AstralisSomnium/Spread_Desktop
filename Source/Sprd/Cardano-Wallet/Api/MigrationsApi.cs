...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
        public interface IMigrationsApi : IApiAccessor
    {
        ...
        InlineResponse2009 GetShelleyWalletMigrationInfo (string walletId);
        ...
        ApiResponse<InlineResponse2009> GetShelleyWalletMigrationInfoWithHttpInfo (string walletId);
        /// <summary>
        /// Migrate
        /// </summary>
        /// <remarks>
        ...
        List<InlineResponse2004> MigrateShelleyWallet (Body11 body, string walletId);
        ...
        ApiResponse<List<InlineResponse2004>> MigrateShelleyWalletWithHttpInfo (Body11 body, string walletId);
        ...
        System.Threading.Tasks.Task<InlineResponse2009> GetShelleyWalletMigrationInfoAsync (string walletId);
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse2009>> GetShelleyWalletMigrationInfoAsyncWithHttpInfo (string walletId);
        /// <summary>
        /// Migrate
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<List<InlineResponse2004>> MigrateShelleyWalletAsync (Body11 body, string walletId);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<InlineResponse2004>>> MigrateShelleyWalletAsyncWithHttpInfo (Body11 body, string walletId);
        ...
        public partial class MigrationsApi : IMigrationsApi
    {
        ...
        /// <returns></returns>
        public MigrationsApi(IO.Swagger.Client.Configuration configuration = null)
        {
        ...
        /// <summary>
        /// Calculate Cost &lt;p align&#x3D;\&quot;right\&quot;&gt;status: &lt;strong&gt;disabled&lt;/strong&gt;&lt;/p&gt; &lt;strong&gt;⚠️IMPORTANT⚠️&lt;/strong&gt; This endpoint has been temporarily disabled with the introduction of multi-assets UTxO. It will be enabled again soon.  &lt;hr/&gt;  Calculate the exact cost of sending all funds from particular Shelley wallet to a set of addresses. 
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="walletId"></param>
        /// <returns>InlineResponse2009</returns>
        public InlineResponse2009 GetShelleyWalletMigrationInfo (string walletId)
        {
             ApiResponse<InlineResponse2009> localVarResponse = GetShelleyWalletMigrationInfoWithHttpInfo(walletId);
        ...
        /// <param name="walletId"></param>
        /// <returns>ApiResponse of InlineResponse2009</returns>
        public ApiResponse< InlineResponse2009 > GetShelleyWalletMigrationInfoWithHttpInfo (string walletId)
        {
            // verify the required parameter 'walletId' is set
            if (walletId == null)
                throw new ApiException(400, "Missing required parameter 'walletId' when calling MigrationsApi->GetShelleyWalletMigrationInfo");
            ...
            {
                Exception exception = ExceptionFactory("GetShelleyWalletMigrationInfo", localVarResponse);
        ...
        /// <param name="walletId"></param>
        /// <returns>Task of InlineResponse2009</returns>
        public async System.Threading.Tasks.Task<InlineResponse2009> GetShelleyWalletMigrationInfoAsync (string walletId)
        {
             ApiResponse<InlineResponse2009> localVarResponse = await GetShelleyWalletMigrationInfoAsyncWithHttpInfo(walletId);
             return localVarResponse.Data;
        ...
        /// <param name="walletId"></param>
        /// <returns>Task of ApiResponse (InlineResponse2009)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<InlineResponse2009>> GetShelleyWalletMigrationInfoAsyncWithHttpInfo (string walletId)
        {
            // verify the required parameter 'walletId' is set
            if (walletId == null)
                throw new ApiException(400, "Missing required parameter 'walletId' when calling MigrationsApi->GetShelleyWalletMigrationInfo");
        ...
        /// <param name="walletId"></param>
        /// <returns>ApiResponse of List&lt;InlineResponse2004&gt;</returns>
        public ApiResponse< List<InlineResponse2004> > MigrateShelleyWalletWithHttpInfo (Body11 body, string walletId)
        {
