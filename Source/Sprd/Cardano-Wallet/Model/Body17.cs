...
namespace IO.Swagger.Model
{
        ...
        public partial class Body17 :  IEquatable<Body17>, IValidatableObject
    {
        ...
        public Body17(List<WalletswalletIdpaymentfeesPayments> payments = default(List<WalletswalletIdpaymentfeesPayments>))
        {
            // to ensure "payments" is required (not null)
            if (payments == null)
            {
                throw new InvalidDataException("payments is a required property for Body17 and cannot be null");
            }
            else
            {
