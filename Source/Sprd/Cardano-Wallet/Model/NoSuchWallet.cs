...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class NoSuchWallet :  IEquatable<NoSuchWallet>, IValidatableObject
    {
        /// <summary>
        /// Defines Code
        /// </summary>
        ...
        {
            /// <summary>
            /// Enum Wallet for value: no_such_wallet
            /// </summary>
            [EnumMember(Value = "no_such_wallet")]
            Wallet = 1        }
        /// <summary>
        /// Gets or Sets Code
        /// </summary>
        ...
        /// </summary>
        /// <value>May occur when a given walletId does not match with any known wallets (because it has been deleted, or has never existed). </value>
        ...
        {
            return this.Equals(input as NoSuchWallet);
        }

        /// <summary>
        /// Returns true if NoSuchWallet instances are equal
        /// </summary>
        /// <param name="input">Instance of NoSuchWallet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NoSuchWallet input)
        {
            if (input == null)
                return false;
