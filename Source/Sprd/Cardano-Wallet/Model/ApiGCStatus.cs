...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApiGCStatus :  IEquatable<ApiGCStatus>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiGCStatus" /> class.
        /// </summary>
        /// <param name="status">status (required).</param>
        /// <param name="lastRun">lastRun.</param>
        public ApiGCStatus(StatusEnum status = default(StatusEnum), string lastRun = default(string))
        {
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for ApiGCStatus and cannot be null");
            }
            else
            {
                this.Status = status;
        ...
        {
            return this.Equals(input as ApiGCStatus);
        }

        /// <summary>
        /// Returns true if ApiGCStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiGCStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiGCStatus input)
        {
            if (input == null)
                return false;
