...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApiAsset :  IEquatable<ApiAsset>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiAsset" /> class.
        /// </summary>
        ...
        public ApiAsset(string policyId = default(string), string assetName = default(string), string fingerprint = default(string), NativeAssetsMetadata metadata = default(NativeAssetsMetadata))
        {
            // to ensure "policyId" is required (not null)
            if (policyId == null)
            {
                throw new InvalidDataException("policyId is a required property for ApiAsset and cannot be null");
            }
            else
            {
            ...
            if (assetName == null)
            {
                throw new InvalidDataException("assetName is a required property for ApiAsset and cannot be null");
            }
            else
            {
            ...
            if (fingerprint == null)
            {
                throw new InvalidDataException("fingerprint is a required property for ApiAsset and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ApiAsset);
        }

        /// <summary>
        /// Returns true if ApiAsset instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiAsset to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiAsset input)
        {
            if (input == null)
                return false;
